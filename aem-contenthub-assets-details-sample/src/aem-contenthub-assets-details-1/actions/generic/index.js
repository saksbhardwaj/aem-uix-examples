...
/**
 * Handle extend expiry request: create task and link asset
 */
async function handleCreateExtendExpiryRequest(params, logger) {
    try {
        // Get access token
        ...
        const taskData = {
            ...
            description: params.taskDescription || 'Task created from AEM Content Hub asset',
...
async function main(params) {
    ...
    try {
        ...
        if (params.action === 'createTaskAndLinkAsset') {
            return await handleCreateExtendExpiryRequest(params, logger);
        }
